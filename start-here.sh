...
case $CHOICE in
    1)
        ...
        echo -e "  Ctrl-b 0  - Developer: Claude Code interactive session"
        echo -e "  Ctrl-b 1  - Tech Lead: Formatted dashboard with observations"
        echo -e "  Ctrl-b 2  - Monitor: System status and activity summary"
        echo -e "  Ctrl-b 3  - Dev Loop: Developer background process logs"
        echo -e "  Ctrl-b 4  - Lead Loop: Tech lead background process logs"
        echo -e "  Ctrl-b n  - Next window  |  Ctrl-b p  - Previous window"
