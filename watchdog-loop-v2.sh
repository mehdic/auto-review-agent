#!/bin/bash
# Watchdog/Reviewer Loop V2 - Fixed communication issues
...
log_message "═══════════════════════════════════════════════════════════"
log_message "Watchdog Loop V2 Starting"
log_message "Monitoring implementer in session: $SESSION_NAME"
log_message "═══════════════════════════════════════════════════════════"

# Monitoring configuration
CHECK_INTERVAL=30  # Check every 30 seconds
IDLE_THRESHOLD=600  # 10 minutes without file changes (increased from 5)
