...
# Use dedicated script for dashboard (avoids escaping issues)
tmux send-keys -t "$SESSION_NAME:tech-lead" "watch -n 3 -c '$SCRIPT_DIR/show-tech-lead-dashboard.sh \"$COORDINATION_DIR\"'"
